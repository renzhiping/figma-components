...
import type { InfoAction as InfoActionData } from "@/data/info-action";

type InfoActionProps = {
    data: InfoActionData;
};

export function InfoAction({ data }: InfoActionProps) {
    return (
        <Card className="w-full max-w-4xl mx-auto shadow-lg border-0 bg-white/95 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="flex justify-center pt-4">
                    <Button className="px-12 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105" size="lg">
                        {data.ctaText}
                    </Button>
                </div>
            </CardContent>
